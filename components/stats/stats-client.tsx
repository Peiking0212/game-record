...
export function StatsClient() {
  ...
  return (
    <>
      ...
      <section className="py-8 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">游戏详细数据</h2>
            ...
            <table className="w-full text-left">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-4 font-semibold text-gray-700">游戏时长</th>
      ...
      <Modal open={summaryOpen} onClose={() => setSummaryOpen(false)} maxWidth="xl">
        ...
        <div ref={summaryContentRef} className="space-y-6">
          <div className="text-center mb-6">
            ...
            <p className="text-lg opacity-90">年度游戏回顾</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <SummaryStat value={String(summary.games)} label="款游戏" />
            <SummaryStat value={String(summary.hours)} label="游戏小时" />
